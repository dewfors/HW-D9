# Generated by Django 5.1 on 2024-09-23 07:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='subscribers',
            field=models.ManyToManyField(related_name='categories', through='posts.CategorySubscribe', to=settings.AUTH_USER_MODEL),
        ),
    ]
